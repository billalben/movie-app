...
// return only trailers and teasers from YouTube as an array
...
fetchDataFromServer(
  ...
  function (movie) {
    ...
    for (const { key, name } of filterVideos(videos)) {
      const videCard = document.createElement("div");
      videCard.classList.add("video-card");
      ...
      movieDetail.querySelector(".slider-inner").appendChild(videCard);
    }
